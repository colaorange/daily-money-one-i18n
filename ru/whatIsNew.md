...
### В версии 1.10.0
В этом выпуске представлены следующие обновления функций:
* Выделите балансовый отчет на главном экране, чтобы ваши ежемесячные расходы были четко видны с первого взгляда.
* Поддержка повторяющихся настроек бюджета, что упрощает отслеживание остатка средств на текущий месяц.
