...
> 1. এক বা একাধিক `খাতা`
> 2. খাতা-এর ভিতরে বিভিন্ন `অ্যাকাউন্ট`
> 3. বিভিন্ন অ্যাকাউন্টের মধ্যে পরিমাণ স্থানান্তর এবং এই `লেনদেন` গুলি রেকর্ড করা

## ![খাতা](icon:///notebook-multiple) অ্যাকাউন্ট বই
...
যখন অ্যাকাউন্টগুলির মধ্যে একটি লেনদেন হয়, যেমন ব্যয়, তোলা, জমা বা ক্রেডিট কার্ড সোয়াইপ করা (যেমন, আপনি ৩২০ টাকা একটি খাবারে ব্যয় করেছেন), তখন `নতুন লেনদেন` ব্যবহার করে একটি নতুন লেনদেন তৈরি করুন।
> - `তারিখ ও সময়` নির্বাচন করুন: লেনদেনের তারিখ ও সময়।
> - `উৎস অ্যাকাউন্ট` নির্বাচন করুন: নগদ
> - `গন্তব্য অ্যাকাউন্ট` নির্বাচন করুন: খাবার
> - `পরিমাণ` ইনপুট করুন: ৩২০
> - `নোট` ইনপুট করুন: বন্ধুদের সাথে জমায়েত
...
> উৎস `আয়` অ্যাকাউন্ট: বেতন
> গন্তব্য `সম্পদ` অ্যাকাউন্ট: ব্যাংক

### ব্যাংক থেকে নগদ উত্তোলন

> উৎস `সম্পদ` অ্যাকাউন্ট: ব্যাংক
> গন্তব্য `সম্পদ` অ্যাকাউন্ট: নগদ

### ক্রেডিট কার্ড দিয়ে ফোন কেনা

> উৎস `দায়` অ্যাকাউন্ট: ক্রেডিট কার্ড
> গন্তব্য `ব্যয়` অ্যাকাউন্ট: ইলেকট্রনিক্স

### ব্যাংকের সাথে ক্রেডিট কার্ড বিল পরিশোধ

> উৎস `সম্পদ` অ্যাকাউন্ট: ব্যাংক
> গন্তব্য `দায়` অ্যাকাউন্ট: ক্রেডিট কার্ড

## ![ব্যালেন্স শিট](icon:///scale-balance)![ব্যালেন্স চার্ট](icon:///chart-pie) ব্যালান্স শীট এবং চার্ট
...
যখন ব্যালান্স শীট বা চার্ট ব্রাউজ করেন, আপনি হোম স্ক্রীনে দ্রুত দৃশ্যে নির্দিষ্ট অ্যাকাউন্ট আইটেমগুলি যোগ করতে পারেন [*1]। ব্যালান্স শীটে আইটেমটির উপর ডানদিকে সোয়াইপ করে এবং `কুইক ভিউতে যোগ করুন` ক্লিক করে, অথবা ব্যালান্স চার্ট কার্ডের উপরের ডান কোণে "কুইক ভিউতে যোগ করুন Icon" ক্লিক করে এটি করতে পারেন। পরবর্তীতে, হোম স্ক্রীনে, আপনি সেই আইটেমের সম্পদ এবং ঋণের ব্যালান্স দেখতে পাবেন, অথবা এটি হোম স্ক্রীনের চার্ট পেজে দেখতে পারেন। এছাড়াও, আপনি `পছন্দ > হোম স্ক্রিন` এ এই আইটেমগুলি সাজাতে বা সরাতে পারেন।

[*1] হোম স্ক্রীনে অত্যধিক দ্রুত দৃশ্যগুলি লোডিং সময় প্রভাবিত করতে পারে।

## লেনদেনের টেমপ্লেট এবং পুনরাবৃত্তি নির্ধারণ

আপনি সাধারণ হিসাবনিকাশ ক্রিয়াকলাপের জন্য লেনদেনের টেমপ্লেট সেট আপ করতে পারেন, যা আপনাকে দ্রুত লেনদেন যোগ করতে দেয়। এছাড়াও আপনি নিয়মিত পুনরাবৃত্তি হিসাবনিকাশ ক্রিয়াকলাপের জন্য পুনরাবৃত্তি সময়সূচী টেমপ্লেট সেট আপ করতে পারেন। প্রোগ্রামটি যখন নির্দিষ্ট সময় আসবে তখন আপনাকে জানিয়ে দেবে, যাতে আপনি দ্রুত লেনদেন যোগ করতে পারেন এবং এটি পরবর্তী সময়ের জন্য স্বয়ংক্রিয়ভাবে নির্ধারণ করতে পারেন। লেনদেনের তালিকায় আইটেমটিতে বাম দিকে সোয়াইপ করুন, তারপর `টেমপ্লেট তৈরি করুন` ট্যাপ করুন এবং সময়সূচী প্রবেশ করান, তারপর এটি তৈরি করুন। এছাড়াও, আপনি `লেনদেন টেমপ্লেট পরিচালনা` পৃষ্ঠায় এই আইটেমগুলি সাজাতে, সম্পাদনা করতে বা অপসারণ করতে পারেন।

## বাজেট সেটিংস

ব্যালেন্স শীট ব্রাউজ করার সময়, কেবল একটি অ্যাকাউন্ট আইটেমে ডান দিকে সোয়াইপ করুন, তারপর `বাজেট তৈরি করুন` এ ক্লিক করুন এবং মোড নির্বাচন করুন। একবার তৈরি হয়ে গেলে, আপনি ব্যালেন্স শীটে বা হোম স্ক্রিনে দ্রুত দৃশ্যে বাজেটের অগ্রগতি দেখতে পারেন। উপরন্তু, আপনি `বাজেট ব্যবস্থাপনা` পৃষ্ঠায় এই আইটেমগুলি সাজাতে, সম্পাদনা করতে বা অপসারণ করতে পারেন।