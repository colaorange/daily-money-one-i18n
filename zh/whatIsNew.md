...
### 在 1.13.0 版本中
本次更新帶來以下功能與改善：
* 在進階編輯帳目時，現在會顯示目前的金額差異，讓你能更方便地調整信用卡手續費或懶人帳金額。
* 新增資產負債趨勢圖，讓你更清楚地掌握資產與負債的變化。
* 強化資產負債分布圖功能。除了可以依帳戶類型建立圖表外，現在也能為個別帳戶新增圖表。

### 在 1.12.0 版本中
這個版本加入了以下功能更新：
* 帳目新增「核對」欄位。信用卡帳目可先設為「未核對」（預設為「已核對」），待日後繳清信用卡費後，可在「帳目列表」中使用「核對模式」，快速與對帳單進行核對。

### 在 1.11.0 版本中
這個版本加入了以下功能更新：
* 發現帶有陰影的按鈕圖示嗎？試著長按看看，會有其他功能喔！
* 我們在首頁加入了挑選帳目範本的捷徑，同時也讓重新排程變得超級簡單、快速！
* 建立新帳本時能順便複製其他帳戶囉！另外在「管理帳戶」頁面也可以複製其他帳戶。
...
* **主頁捷徑設定**：新增了以下捷徑選項：到月底的帳目列表、到月底的資產負債表及至月底財務分布圖
