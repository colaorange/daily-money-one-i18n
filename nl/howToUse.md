[`Bekijk introductievideo op YouTube`](https://youtu.be/uN3GkA_Afuw)
...
## ![Boeken](icon:///notebook-multiple) Boeken

Er is minstens één Boek vereist, met rekeningen in dezelfde valuta-eenheid. Je kunt ook meerdere Boeken met dezelfde valuta-eenheid aanmaken, afhankelijk van je behoeften.

## ![Rekeningen](icon:///bookmark-multiple) Rekeningen

Er zijn vijf verschillende soorten rekeningen die je kunt toevoegen, bewerken of verwijderen in het Rekening-scherm.
...
> - Selecteer `Tijdstip`: Datum en tijd van de transactie.
> - Selecteer `Opname Rekening`: Contant geld
> - Selecteer `Storting Rekening`: Dineren
> - Voer in `Bedrag`: 320
...
> Opname `Inkomsten` rekening: Salaris  
> Storting `Activa` rekening: Bank  

### Contant geld opnemen van bank

> Opname `Activa` rekening: Bank  
> Storting `Activa` rekening: Contant geld  

### Telefoon kopen met creditcard

> Opname `Passiva` rekening: Creditcard  
> Storting `Uitgaven` rekening: Elektronica  

### Creditcardrekening betalen met bank

> Opname `Activa` rekening: Bank  
> Storting `Passiva` rekening: Creditcard  

## ![Balans](icon:///scale-balance)![Balansgrafiek](icon:///chart-pie) Balans & Diagram
