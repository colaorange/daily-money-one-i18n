[`ดูวิดีโอแนะนำบนเพิ่มในมุมมองด่วน`](https://youtu.be/uN3GkA_Afuw)

## แนวคิด

แนวคิดหลักของ Daily Money นั้นง่ายมาก มีเพียงสามข้อ:

> 1. หนึ่งหรือหลาย `สมุดบัญชี`
> 2. บัญชีต่าง ๆ ภายใน สมุดบัญชี
> 3. การโอนเงินระหว่างบัญชีต่าง ๆ และบันทึก `รายการธุรกรรม`

## ![สมุดบัญชี](icon:///notebook-multiple) สมุดบัญชี

ต้องมีอย่างน้อยหนึ่ง Account Book ที่มีบัญชีที่ใช้หน่วยเงินเดียวกัน นอกจากนี้ยังสามารถสร้างหลาย สมุดบัญชี ที่ใช้หน่วยเงินเดียวกันได้ตามต้องการ

## ![บัญชี](icon:///bookmark-multiple) บัญชี

มีบัญชีห้าประเภทที่แตกต่างกัน คุณสามารถเพิ่ม แก้ไข หรือลบบัญชีได้ในหน้าจอการจัดการบัญชี

> - `รายรับ`: เงินเดือน เป็นต้น
> - `รายจ่าย`: อาหาร ความบันเทิง เป็นต้น
> - `สินทรัพย์`: เงินสด ธนาคาร เป็นต้น
> - `หนี้สิน`: บัตรเครดิต สินเชื่อ เป็นต้น
> - `อื่นๆ`: ...
...
## ![รายการธุรกรรม](icon:///การตั้งค่าipt) รายการธุรกรรม

เมื่อมีการทำธุรกรรมระหว่างบัญชี เช่น การใช้จ่าย การถอนเงิน การฝากเงิน หรือการใช้บัตรเครดิต (เช่น คุณใช้จ่าย 320 บาทเพื่อทานข้าว) ให้ใช้ `รายการใหม่` เพื่อสร้างธุรกรรมใหม่
> - เลือก `เวลา`: วันที่และเวลาของธุรกรรม
> - เลือก `ถอน`: เงินสด
> - เลือก `ฝาก`: ทานข้าว
> - ใส่ `จำนวนเงิน`: 320
> - ใส่ `บันทึก`: รวมกลุ่มกับเพื่อน
> - คลิก `สร้าง`
...
> โอนออกจาก `รายรับ` บัญชี: เงินเดือน
> โอนเข้า `สินทรัพย์` บัญชี: ธนาคาร

### ถอนเงินสดจากธนาคาร

> โอนออกจาก `สินทรัพย์` บัญชี: ธนาคาร
> โอนเข้า `สินทรัพย์` บัญชี: เงินสด

### ซื้อโทรศัพท์ด้วยบัตรเครดิต

> โอนออกจาก `หนี้สิน` บัญชี: บัตรเครดิต
> โอนเข้า `รายจ่าย` บัญชี: อิเล็กทรอนิกส์

### ชำระบิลบัตรเครดิตด้วยเงินจากธนาคาร

> โอนออกจาก `สินทรัพย์` บัญชี: ธนาคาร
> โอนเข้า `หนี้สิน` บัญชี: บัตรเครดิต

## ![งบดุล](icon:///scale-balance)![กราฟยอดคงเหลือ](icon:///chart-pie) งบดุลและกราฟ
...
## เทมเพลตการทำธุรกรรมและการกำหนดเวลาที่เกิดขึ้นเป็นประจำ

คุณสามารถตั้งค่าเทมเพลตการทำธุรกรรมสำหรับการกระทำทางบัญชีทั่วไป ทำให้คุณสามารถเพิ่มการทำธุรกรรมได้อย่างรวดเร็ว นอกจากนี้คุณยังสามารถตั้งค่าเทมเพลตการกำหนดเวลาที่เกิดขึ้นเป็นประจำสำหรับการกระทำทางบัญชีที่เกิดขึ้นเป็นประจำ โปรแกรมจะเตือนคุณเมื่อถึงกำหนด ทำให้คุณสามารถเพิ่มการทำธุรกรรมได้อย่างรวดเร็วและกำหนดเวลาอัตโนมัติสำหรับครั้งถัดไป เพียงเลื่อนซ้ายที่รายการในรายการการทำธุรกรรม จากนั้นแตะ `สร้างเทมเพลต` และป้อนเวลาการกำหนดเวลา แล้วสร้างเทมเพลต นอกจากนี้คุณยังสามารถจัดเรียง แก้ไข หรือลบรายการเหล่านี้ใน `หน้าการจัดการเทมเพลตการทำธุรกรรม`

## การตั้งค่างบประมาณ

เมื่อเรียกดูงบดุล เพียงเลื่อนไปทางขวาที่รายการบัญชี จากนั้นคลิก `สร้างงบประมาณ` และเลือกโหมด เมื่อสร้างแล้ว คุณสามารถดูความคืบหน้าของงบประมาณได้ในงบดุลหรือมุมมองด่วนบนหน้าจอหลัก นอกจากนี้ คุณสามารถจัดเรียง แก้ไข หรือลบรายการเหล่านี้ได้ในหน้า `การจัดการงบประมาณ`
